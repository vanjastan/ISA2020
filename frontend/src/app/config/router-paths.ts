...
export const RATE = 'adminph/rate';
export const RATE_P = 'adminph/ratep';
...
export const SUPPLIER_TENDER = 'supplier/suppliertender';
...
export const PATIENT_PROFILE_PRESCRIPTIONS = 'patient/prescriptions';
export const SHEDULED_EXAMINATIONS = 'patient/sheduledExaminations';
export const RESERVED_MEDS = 'patient/reservedMed';
