...
@Component({
  selector: 'app-adminregderm',
  templateUrl: './adminregderm.component.html',
  styleUrls: ['./adminregderm.component.css']
})
export class AdminRegDermComponent implements OnInit {
  ...
  onRegisterSubmit(): void {
    ...
    this.userService.registerDerm(userInfo).subscribe(data => {
